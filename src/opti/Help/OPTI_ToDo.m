...
% but definitely some for under-grads and grads.
...
% Provide native support for (MI)QCQP problems, writing of AMPL solution
% files, preserve objective and constraint naming + other tidy ups. Perhaps
...
% - Prepare for Visual Studio 2012
% Currently MATLAB 2012b only supports Visual Studio 2010, but 2013a is
% reported to support Visual Studio 2012. This means all solver libraries
% will need to be rebuilt against VC++ 2012, as well as the OPTI pre-req 
% checker updated for VC++ 2012 runtimes.
