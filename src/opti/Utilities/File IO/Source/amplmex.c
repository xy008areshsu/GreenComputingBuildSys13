...
//Structure Arguments
enum{eH,eF,eLB,eUB,eA,eCL,eCU,eQ,eL,eQCIND,eX0,eV0,eSENSE,eCONLIN};
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    //Outputs
    const char *fnames[14] = {"H","f","lb","ub","A","cl","cu","Q","l","qcind","x0","v0","sense","conlin"};
    double *sizes;
    ...
    switch(icmd)
    {
        ...
        case ASLCMD_OPEN:
            ...
            pPROB = mxCreateStructMatrix(1,1,14,fnames);
        ...
        case ASLCMD_GRAD:
			...
			g = mxGetPr(plhs[0] = mxCreateDoubleMatrix(n_var, 1, mxREAL));            
			objgrd(0, x, g, &nerror);            
            break;
