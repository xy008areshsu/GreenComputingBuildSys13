...
if(isempty(strfind(lower(filename),['.' filetype])))
...
%Call coin-or mex
[f,A,rl,ru,lb,ub,ivars,H,name,sostype,sosind,soswt] = coinR(p,filetype,print);
...
prob = optiprob('H',H,'f',f,'lin',A,rl,ru,'bounds',lb,ub,'int',int,'name',name,'sos',sostype,sosind,soswt);
