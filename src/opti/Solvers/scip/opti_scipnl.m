...
if(~isempty(nlcon))
    try
        ...
        ex = MException('OPTI:SCIP',['There was an error processing a constraint function into SCIP compatible form.\n'...
...
if(~isempty(fun))
    try
        ...
        ex = MException('OPTI:SCIP',['There was an error processing the objective function into SCIP compatible form.\n'...
                                    'Please examine the below error to correct your function:\n\n%s\n\n(Remember SCIP only supports a subset of MATLAB commands)\n\n'],ME.message); 
        throwAsCaller(ex);
    end    
