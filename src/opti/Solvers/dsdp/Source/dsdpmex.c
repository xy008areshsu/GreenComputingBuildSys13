/* DSDPMEX - A simple MEX Interface to DSDP SDP Solver
 * Copyright (C) Jonathan Currie 2013 (I2C2)
 *
...
static int DSDPMonitor(DSDP dsdp, void* dummy)
{
    ...
    if(printLevel>1) {
        ...
        if(iter==0 || iter % 20 == 0)
            mexPrintf("Iter    Time    PP Objective      DD Objective     PInfeas   DInfeas     Nu     StepLength   Pnrm\n");
